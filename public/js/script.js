...
$(document).on("click", ".active_inactive_ads_second_item_child_edit_link_delete_btn", function () {
    ...
    $.ajax({
        url: `http://bowy.ru/BowyLaravel/public/products/${$(this).data('id')}`,
...
$(document).on("click", ".badge", function () {
    ...
    $.ajax({
        url: `http://bowy.ru/BowyLaravel/public/admin/${$(this).data('id')}`,
...
$(document).on("click", ".add_region_data", function () {
    ...
    $.ajax({
        url: "http://bowy.ru/BowyLaravel/public/getCityByRegionId",
...
$(document).on("submit", ".place_an_ad_form", function (event) {
    ...
    $.ajax({
        url: "http://bowy.ru/BowyLaravel/public/profile/create-products",
...
$(document).on("click", ".add-favorite", function () {
    ...
    $.ajax({
        url: "http://bowy.ru/BowyLaravel/public/profile/favourites",
...
$(document).on("click", ".remove-favourite", function () {
    ...
    var product_id = thisis.data('id');
    $.ajax({
        url: `http://bowy.ru/BowyLaravel/public/profile/favourites-destroy/${product_id}`,
...
$(document).on("submit", ".update_place_an_ad", function (event) {
    ...
    $.ajax({
        url: "http://bowy.ru/BowyLaravel/public/announcement_update",
...
$(document).on("click", ".remove-favourites", function () {
    ...
    var product_id = thisis.data('id');
    $.ajax({
        url: `http://bowy.ru/BowyLaravel/public/profile/favourites-delete/${product_id}`,
...
$(".call").on("click", function (event) {
    ...
    $.ajax({
        url: `http://bowy.ru//BowyLaravel/public/profile/announcement-unlogged/${product_id}`,
