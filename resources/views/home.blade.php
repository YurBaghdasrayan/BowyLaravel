                            ...
                            <div class="recent_announcements_item_child">
                                ...
                                <div class="recent_announcements_item_child_info_box">
                                    ...
                                    <div class="recent_announcements_items_child_call_message_btns_wrapper">
                                        <a class="recent_announcements_items_child_call_btn call_user call" data-id="{{$products->id}}">
                                        ...
                                        @auth()
                                        <button class="recent_announcements_items_child_message_btn open_users_chat">
