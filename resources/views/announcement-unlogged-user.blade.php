                    ...
                    <div class="announcement_items_wrapper">
                        ...
                        <div class="announcement_first_item">
                            ...
                            <div class="unlogged_user_announcement_item_call_message_btns_wrapper">
                                <a href="tel:{{$unnloged->user->number}}" class="unlogged_user_announcement_item_child_call_btn">
                                ...
                                <button class="unlogged_user_announcement_item_child_message_btn">
...
{{--                            <!--</div>-->--}}
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="swiper_slide_img">
                                            <img src="{{asset('storage/uploads/' . $unnlogeds[0]->image)}}" alt="">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="swiper_slide_img">
                        ...
                        <div class="announcement_second_item_car_info_details_wrapper">
                            <div class="announcement_second_item_car_info_details">
                                ...
                                <p class="announcement_second_item_car_info_details_text">{{$unnlogeds[0]->address}}</p>
                            </div>
                            <div class="announcement_second_item_car_info_details">
                                <p class="announcement_second_item_car_info_details_title">Описание</p>
                                <p class="announcement_second_item_car_info_details_text">{{$unnlogeds[0]->description}}</p>
                            </div>
                        </div>
                        <div class="announcement_second_item_specifications_wrapper">
                            ...
                            <div class="announcement_second_item_specifications">
                                ...
                                <p class="announcement_second_item_specifications_info">{{$unnlogeds[0]->car_model}}</p>
                            </div>
                            <div class="announcement_second_item_specifications">
                                <p class="announcement_second_item_specifications_title">Тип кузова:</p>
                                <p class="announcement_second_item_specifications_info">{{$unnlogeds[0]->body_type}}</p>
                            </div>
                            <div class="announcement_second_item_specifications">
                                <p class="announcement_second_item_specifications_title">Год выпуска:</p>
                                <p class="announcement_second_item_specifications_info">{{$unnlogeds[0]->year_of_issue}}</p>
                            </div>
                            <div class="announcement_second_item_specifications">
                                <p class="announcement_second_item_specifications_title">Коробка передач:</p>
                                <p class="announcement_second_item_specifications_info">{{$unnlogeds[0]->transmission}}</p>
                            </div>
                            <div class="announcement_second_item_specifications">
                                <p class="announcement_second_item_specifications_title">Руль:</p>
                                <p class="announcement_second_item_specifications_info">{{$unnlogeds[0]->rudder}}</p>
                            </div>
                        </div>
