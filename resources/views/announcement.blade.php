...
@section('content')
    ...
    <div class="bowy_mian_wrapper" id="announcement_page">
        <main>
                    ...
                    <div class="announcement_items_wrapper">
                        <div class="announcement_first_item">
                            ...
                            <div class="active_inactive_ads_first_item_links_wrapper">
                                <a href="../html/active_inactive_ads.html" class="active_inactive_ads_first_item_link">Мои объявления</a>
                                <a href="../html/profile_settings.html" class="active_inactive_ads_first_item_link">Настройки профиля</a>
                        ...
                        <div class="announcement_second_item">
                            ...
                            <div class="announcement_second_item_titles_links_btns_wrapper">
                                <div class="announcement_second_item_titles_wrapper">
                                    <p class="announcement_second_item_title">Аренда авто без залога</p>
                                    <p class="announcement_second_item_title">1 290 ₽ </p>
                                </div>
                            ...
                            <div class="announcement_second_item_car_info_details_wrapper">
                                <div class="announcement_second_item_car_info_details">
                                    ...
                                    <p class="announcement_second_item_car_info_details_text">Лиговский проспект 11</p>
                                </div>
                                <div class="announcement_second_item_car_info_details">
                                    <p class="announcement_second_item_car_info_details_title">Описание</p>
                                    <p class="announcement_second_item_car_info_details_text">Идейные соображения высшего порядка, а также укрепление и развитие структуры играет важную роль в формировании модели развития.</p>
                                </div>
                            </div>
