                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <form class="admin-update-users" method="post">
                                            @csrf
                                                <div>
                                                    <input style="margin-right: 10px" type="text" name="ClientName">
                                                    <input style="margin-right: 10px" type="text" name="Email">
                                                    <input style="margin-right: 10px" type="text" name="Surname">
                                                    <input style="margin-right: 10px" type="text" name="Number">
                                                    <input style="margin-right: 10px" type="text" name="City">
                                                </div>
                                            <button type="submit" class="badge badge-outline-danger" style="height: 100%; background: unset; ">Update</button>
                                        </form>
